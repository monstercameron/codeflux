...
// ValidateTaskBudgetBeforeModelRequest checks a task limit before provider work begins.
//
// Codeflux atom documentation (schema v1):
//
//	Purpose:
//	  Payment payment payment payment payment payment payment budget guard.
//	Use when:
