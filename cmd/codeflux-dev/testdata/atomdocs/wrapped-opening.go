...
// ValidateTaskBudgetBeforeModelRequest checks a task limit before provider work
// begins, so a metered request cannot exceed what the task was approved to spend.
//
