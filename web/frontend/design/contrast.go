...
func FixedContrastPairs(tokens Tokens) []ContrastPair {
	...
	return []ContrastPair{
		...
		{Name: "code-kind", Foreground: colors.OnCode, Background: colors.Code, Minimum: MinimumNormalTextContrast},
		{Name: "test-kind", Foreground: colors.OnTest, Background: colors.Test, Minimum: MinimumNormalTextContrast},
		{Name: "memory-kind", Foreground: colors.OnMemory, Background: colors.Memory, Minimum: MinimumNormalTextContrast},
		{Name: "forecast-kind", Foreground: colors.OnForecast, Background: colors.Forecast, Minimum: MinimumNormalTextContrast},
		{Name: "execution-kind", Foreground: colors.OnExecution, Background: colors.Execution, Minimum: MinimumNormalTextContrast},
		{Name: "validation-kind", Foreground: colors.OnValidation, Background: colors.Validation, Minimum: MinimumNormalTextContrast},
		...
		{Name: "code-signal-on-surface-2", Foreground: colors.Code, Background: colors.Surface2, Minimum: MinimumLargeTextContrast},
		{Name: "test-signal-on-surface-2", Foreground: colors.Test, Background: colors.Surface2, Minimum: MinimumLargeTextContrast},
		{Name: "memory-signal-on-surface-2", Foreground: colors.Memory, Background: colors.Surface2, Minimum: MinimumLargeTextContrast},
		{Name: "forecast-signal-on-surface-2", Foreground: colors.Forecast, Background: colors.Surface2, Minimum: MinimumLargeTextContrast},
		{Name: "execution-signal-on-surface-2", Foreground: colors.Execution, Background: colors.Surface2, Minimum: MinimumLargeTextContrast},
		{Name: "validation-signal-on-surface-2", Foreground: colors.Validation, Background: colors.Surface2, Minimum: MinimumLargeTextContrast},
		...
		{Name: "code-signal-on-surface-3", Foreground: colors.Code, Background: colors.Surface3, Minimum: MinimumLargeTextContrast},
		{Name: "test-signal-on-surface-3", Foreground: colors.Test, Background: colors.Surface3, Minimum: MinimumLargeTextContrast},
		{Name: "memory-signal-on-surface-3", Foreground: colors.Memory, Background: colors.Surface3, Minimum: MinimumLargeTextContrast},
		{Name: "forecast-signal-on-surface-3", Foreground: colors.Forecast, Background: colors.Surface3, Minimum: MinimumLargeTextContrast},
		{Name: "execution-signal-on-surface-3", Foreground: colors.Execution, Background: colors.Surface3, Minimum: MinimumLargeTextContrast},
		{Name: "validation-signal-on-surface-3", Foreground: colors.Validation, Background: colors.Surface3, Minimum: MinimumLargeTextContrast},
