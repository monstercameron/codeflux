...
func ToolCatalog() []ToolDescriptor {
	result := []ToolDescriptor{
		...
		{Name: ToolTest, SchemaVersion: ToolSchemaVersion, Summary: "Run an approved test recipe", DefaultAuthority: AuthorityAutomaticRead, Effects: []SideEffect{EffectSubprocess, EffectRepositoryRead}},
