...
var Checks = []StageCheck{
	...
	{StageDecompositionCover, "checkDecompositionCoverage", true, ""},
	...
	{StageAtomDocumentation, "documentAtoms", true, ""},
	{StageAtomCaseSynthesis, "synthesiseAtomCases", true, ""},
	...
	{StagePathCoverage, "measureCoverage", true, "PIPE-115"},
	{StageProgram, "AgentExecution.Run", true, ""},
	{StageAssembly, "checkAssembly", true, ""},
