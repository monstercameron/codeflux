...
var Flow = []Stage{
	...
	{StageCompositionObligations, "composition-obligations",
		"what each molecule must guarantee is stated, and each obligation names the atoms that discharge it"},
	...
	{StageMoleculeVerification, "molecule-verification",
		"every molecule test passes and every stated obligation is discharged"},

	{StageControlObligations, "control-obligations",
		"ordering, termination, cancellation, and error propagation are stated for every path"},
	{StageControlTests, "control-tests",
		"every declared path, including each failure path, has a test"},
	{StageControlFlow, "control-flow",
		"the orchestration terminates and leaves no path unreachable or undischarged"},
	...
	{StagePlatformMatrix, "platform-matrix",
		"the program passes on every platform it claims to support"},
	{StageNonFunctional, "non-functional",
		"performance and resource use are within budget, compared against a recorded baseline"},
