...
var Registry = []KindDescriptor{
	...
	{Name: "session.change.acceptance.updated"},
	...
	{Name: "session.task.projection.invalidated"},
	{Name: "session.task.state.changed"},
	{Name: "session.thread.archived"},
	{Name: "session.thread.created"},
	{Name: "session.thread.renamed"},
